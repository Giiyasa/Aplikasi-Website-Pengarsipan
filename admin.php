                ...
                if (isset($_REQUEST['page'])) {
                    ...
                    switch ($page) {
                        ...
                        case 'gsk':
                            ...
                            break;
                        case 'arm';
                            include "arsip_sm.php";
                            break;
                        case 'ark';
                            include "arsip_sk.php";
                            break;
                        case 'lemari1sm';
                            include "arsip/lemari1.php";
                            break;
                        case 'lemari2sm';
                            include "arsip/lemari2.php";
                            break;
                        case 'lemari1sk';
                            include "arsip/lemari3.php";
                            break;
                        case 'lemari2sk';
                            include "arsip/lemari4.php";
                            break;
                    }
                } else {
                ?>
                            ...
                            <div class="card indigo">
                                <div class="card-content">
                                    ...
                                    <p class="description">Anda login sebagai
                                        <?php
                                        if ($_SESSION['admin'] == 1) {
                                            echo "<strong>kepala Desa </strong>. Anda memiliki akses penuh terhadap sistem.";
                                        } elseif ($_SESSION['admin'] == 2) {
                                            echo "<strong>Kasi Pelayanan</strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
                                        } else {
                                            echo "<strong>Sekertaris Desa </strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
                                        } ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <a href="?page=ref">
                            <div class="col s12 m4">
                                <div class="card deep-orange">
                                    <div class="card-content">
                                        <span class="card-title white-text"><i class="material-icons md-36">class</i> Jumlah indeks Surat</span>
