...
?>
    ...
    <nav class="red darken-1">
        <div class="nav-wrapper">
            <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">description</i> ARSIP</a>
            <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                ...
                if ($_SESSION['admin'] == 1 || $_SESSION['admin'] == 3) { ?>
                    <li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            <li>
                                <a class="collapsible-header"><i class="material-icons">document</i> Arsip</a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="?page=arm">Surat Masuk</a></li>
                                        <li><a href="?page=ark">Surat Keluar</a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
            ...
            <ul class="center hide-on-med-and-down" id="nv">
                <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">description</i> ARSIP</a></li>
                <li>
                    <div class="grs">
                        </>
                </li>
                ...
                <?php
                if ($_SESSION['admin'] == 1 || $_SESSION['admin'] == 3) { ?>
                    <li><a class="dropdown-button" href="#!" data-activates="agenda">Arsip<i class="material-icons md-18">arrow_drop_down</i></a></li>
                    <ul id='agenda' class='dropdown-content'>
                        <li><a href="?page=arm">Surat Masuk</a></li>
                        <li><a href="?page=ark">Surat Keluar</a></li>
                    </ul>
