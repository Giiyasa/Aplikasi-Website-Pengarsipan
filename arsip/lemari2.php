...
if (empty($_SESSION['admin'])) {
    ...
    if ($_SESSION['admin'] != 1 and $_SESSION['admin'] != 3) {
        ...
        if (isset($_REQUEST['act'])) {
            ...
            $query = mysqli_query($config, "SELECT surat_masuk FROM tbl_sett Limit 20 offset 21");
                    ...
                    <div class="z-depth-1">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue-grey darken-1">
                                <div class="col m7">
                                    <ul class="left">
                                        <li class="waves-effect waves-light hide-on-small-only"><a href="?page=arm" class="judul"><i class="material-icons">description</i> Arsip Surat Masuk</a></li>
                                    </ul>
                                </div>
                            </div>
                        </nav>
    ...
    <?php
            if (isset($_REQUEST['submit'])) {
                ...
                echo '
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    <th width="10%">No. Surats<br/>Kode</th>
                ...
                $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE nama_pengirim LIKE '%$cari%' ORDER by id_surat DESC LIMIT 15");
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        echo '
                                  <tr>
                                    ...
                                    <td>' . substr($row['nama_pengirim'], 0, 200) . '<br/><br/><strong>File :</strong>';
                ...
                echo '
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        <th width="10%">No. Surat<br/>index surat</th>
                                        <th width="30%"> Nama Pengirim<br/> File</th>
                                        <th width="24%">Asal Surat</th>
                                        <th width="18%">No. Surat<br/>Tgl Surat</th>
                ...
                $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk ORDER by id_surat DESC LIMIT 20 offset 21");
                if (mysqli_num_rows($query) > 0) {
                    $no = 1;
                    while ($row = mysqli_fetch_array($query)) {
                        echo '
