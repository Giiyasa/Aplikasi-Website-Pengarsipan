...
if (empty($_SESSION['admin'])) {
    ...
    if ($_SESSION['admin'] != 1 and $_SESSION['admin'] != 3) {
        ...
        if (isset($_REQUEST['act'])) {
            ...
            $query = mysqli_query($config, "SELECT surat_keluar FROM tbl_sett LIMIT 20");
                    ...
                    <div class="z-depth-1">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue-grey darken-1">
                                <div class="col m7">
                                    <ul class="left">
                                        <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsk" class="judul"><i class="material-icons">drafts</i> Arsip Surat Keluar</a></li>
