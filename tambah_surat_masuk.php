<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['no_agenda'] == "" || $_REQUEST['no_surat'] == "" || $_REQUEST['asal_surat'] == "" || $_REQUEST['nama_pengirim'] == ""
                    ...
                    if(!preg_match("/^[a-zA-Z0-9.\/ -]*$/", $no_surat)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $asal_surat)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $nama_pengirim)){
                                $_SESSION['nama_pengirim'] = 'Form nama_pengirim Ringkas hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), kurung(), underscore(_), dan(&) persen(%) dan at(@)';
                                echo '<script language="javascript">window.history.back();</script>';
                            } else {
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,nama_pengirim,kode,indeks,tgl_surat,
                                                                    tgl_diterima,file,keterangan,id_user)
                                                                        VALUES('$no_agenda','$no_surat','$asal_surat','$nama_pengirim','$nkode','$indeks','$tgl_surat',NOW(),'$nfile','$keterangan','$id_user')");
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,nama_pengirim,kode,indeks,tgl_surat, tgl_diterima,file,keterangan,id_user)
                                                            VALUES('$no_agenda','$no_surat','$asal_surat','$nama_pengirim','$nkode','$indeks','$tgl_surat',NOW(),'','$keterangan','$id_user')");
                ...
                <form class="col s12" method="POST" action="?page=tsm&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            ?>
                            <label for="no_agenda">Nomor Surat</label>
                        </div>
                        <div class="input-field col s6">
                            ...
                            <input id="kode" type="text" class="validate" name="kode" required>
                                ...
                                ?>
                            <label for="kode">index Surat</label>
                        </div>
                        <div class="input-field col s6">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="indeks" type="text" class="validate" name="indeks" required>
                                ...
                                ?>
                            <label for="indeks">Kelompok Berkas</label>
                        </div>
                        <div class="input-field col s6">
                        ...
                        <div class="input-field col s6">
                            ...
                            <textarea id="nama_pengirim" class="materialize-textarea validate" name="nama_pengirim" required></textarea>
                                <?php
                                    if(isset($_SESSION['nama_pengirim'])){
                                        $nama_pengirim = $_SESSION['nama_pengirim'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$nama_pengirim.'</div>';
                                        unset($_SESSION['nama_pengirim']);
                                    }
                                ?>
